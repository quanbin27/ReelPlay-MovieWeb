...
func main() {
	...
	initStorage(db)
	db.AutoMigrate(&types.User{}, types.Movie{}, types.Episode{}, types.Bookmark{}, types.Comment{}, types.Rate{}, types.Director{}, types.Actor{}, types.Category{}, types.UserWatched{})
